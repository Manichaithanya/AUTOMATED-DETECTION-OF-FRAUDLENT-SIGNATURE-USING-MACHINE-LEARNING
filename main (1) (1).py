...
def checkSimilarity(window, path1, path2):
    ...
    if(result <= THRESHOLD):
        messagebox.showerror("Failure: Signature Fraud",
                             "Signature is Fraud ")
        pass
    else:
...
root = tk.Tk()
root.title("Signature Fraud Detection")
root.geometry("500x600")  # 300x200
root.configure(bg="light blue")
root.resizable(False, False)
uname_label = tk.Label(root, text="Signature Fraud Verification:", font=10)
